...
public class ClientConnection implements Client {
     ...
     */
    private final static int                                   RECONNECTING_DELAY = 5000;
    ...
    public ClientConnection(ServerManager serverManager,
                            ...
                            RegisterCache registerCache, RegistryClientConfig config) {
    ...
    private void resetRegister() {
        try {
            ...
            LOGGER.info("[reset] {} publishers and {} subscribers has been reset",
